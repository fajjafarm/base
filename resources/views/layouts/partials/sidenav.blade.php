<!-- resources/views/partials/sidenav.blade.php -->
<!-- Sidenav Menu Start -->
<div class="sidenav-menu">
    ...
    <div data-simplebar>
        ...
        <!-- Water Balance Tests -->
        <li class="side-nav-item">
            <a data-bs-toggle="collapse" href="#sidebarWaterBalanceTest" 
               aria-expanded="false" aria-controls="sidebarWaterBalanceTest" 
        ...
        <ul class="side-nav">
            ...
            <!-- Hospital -->
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#sidebarHospital" 
            ...
            <!-- Invoice -->
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#sidebarInvoice" 
            ...
            <!-- Pages -->
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#sidebarPages" 
            ...
            <!-- Pricing -->
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#sidebarPricing" 
            ...
            <!-- Auth Pages -->
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#sidebarPagesAuth" 
                   aria-expanded="false" aria-controls="sidebarPagesAuth" 
                   class="side-nav-link collapsed">
            ...
            <!-- Error Pages -->
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#sidebarPagesError" 
                   aria-expanded="false" aria-controls="sidebarPagesError" 
                   class="side-nav-link collapsed">
            ...
            <!-- Email Templates -->
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#sidebarEmailTemplates" 
            ...
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#sidebarBaseUI" 
            ...
            <!-- Extended UI -->
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#sidebarExtendedUI" 
            ...
            <!-- Icons -->
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#sidebarIcons" 
            ...
            <!-- Charts -->
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#sidebarCharts" 
            ...
            <!-- Forms -->
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#sidebarForms" 
            ...
            <!-- Tables -->
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#sidebarTables" 
            ...
            <!-- Maps -->
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#sidebarMaps" 
            ...
            <!-- More -->
            <li class="side-nav-title mt-2">More</li>
            <li class="side-nav-item">
            ...
            <!-- Multi Level -->
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#sidebarMultiLevel" 
